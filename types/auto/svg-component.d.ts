...
declare module '~virtual/svg-component' {
  ...
  export const svgNames: ["accounts", "advance-expense", "backup-restore-2", "chart-line", "clearing", "company", "dashboard", "dict", "fixed-deposit", "fullscreen-exit", "fullscreen", "import", "interest-rate", "keyboard-down", "keyboard-enter", "keyboard-esc", "keyboard-up", "permission", "profit-payment", "save", "search-detail", "search", "summary", "transfer"];
  export type SvgName = "accounts" | "advance-expense" | "backup-restore-2" | "chart-line" | "clearing" | "company" | "dashboard" | "dict" | "fixed-deposit" | "fullscreen-exit" | "fullscreen" | "import" | "interest-rate" | "keyboard-down" | "keyboard-enter" | "keyboard-esc" | "keyboard-up" | "permission" | "profit-payment" | "save" | "search-detail" | "search" | "summary" | "transfer";
